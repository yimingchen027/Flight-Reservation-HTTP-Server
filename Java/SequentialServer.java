...
public class SequentialServer {
  public static void main(String[] args) throws IOException {
    ...
    HttpContext context= server.createContext("/", new SequentialHandler());
    SequentialFlights SequentialFlights = new SequentialFlights();
...
class SequentialHandler implements HttpHandler {
